...
export function updatePageBackgroundColor(difference) {
    ...
    if (difference > 5) {
        ...
        gameContainer.style.background = 'linear-gradient( rgba(238, 79, 40, 0.9) 0%,rgb(153, 47, 14) 33.33%, rgb(50, 15, 4) 66.67%, rgb(50, 15, 4) 00%';
        ...
        gameContainer.style.background = 'linear-gradient( rgba(9, 255, 0, 0.9) 0%,rgb(26, 114, 8) 33.33%,rgb(12, 50, 4)66.67%, rgb(12, 50, 4100%';
    }
}
